...
## Purpose
This specification defines the requirement for translating all Python code from Dutch to English to improve code maintainability, consistency, and adherence to Python community conventions. The translation affects internal code (variables, functions, comments) while preserving external interfaces and configuration file formats for backward compatibility.
